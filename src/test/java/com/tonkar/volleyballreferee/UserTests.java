...
public class UserTests extends VbrTests {
    ...
    public void testManageUsers() {
        ...
        ResponseEntity<UserSummary> userResponse = restTemplate.exchange(urlOf(String.format("/public/users/%s", testPurchaseToken1)), HttpMethod.GET, null, UserSummary.class);
    ...
    public void testManageFriends() {
        ...
        ResponseEntity<Count> getFriendsCountResponse = restTemplate.exchange(urlOf("/users/friends/received/count"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken1), Count.class);
        assertEquals(HttpStatus.OK, getFriendsCountResponse.getStatusCode());
        assertEquals(0L, getFriendsCountResponse.getBody().getCount());

        getFriendsCountResponse = restTemplate.exchange(urlOf("/users/friends/received/count"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken2), Count.class);
        assertEquals(HttpStatus.OK, getFriendsCountResponse.getStatusCode());
        ...
        ResponseEntity<List<FriendRequest>> getFriendsResponse = restTemplate.exchange(urlOf("/users/friends/received"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken1), typeReference);
        ...
        getFriendsResponse = restTemplate.exchange(urlOf("/users/friends/requested"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken2), typeReference);
        assertEquals(HttpStatus.OK, getFriendsResponse.getStatusCode());
        assertEquals(0, getFriendsResponse.getBody().size());

        getFriendsResponse = restTemplate.exchange(urlOf("/users/friends/requested"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken1), typeReference);
        assertEquals(HttpStatus.OK, getFriendsResponse.getStatusCode());
        assertEquals(1, getFriendsResponse.getBody().size());

        // List all friends and requests

        ResponseEntity<FriendsAndRequests> friendsAndRequestsResponse = restTemplate.exchange(urlOf("/users/friends"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken1), FriendsAndRequests.class);
        ...
        friendsAndRequestsResponse = restTemplate.exchange(urlOf("/users/friends"), HttpMethod.GET, emptyPayloadWithAuth(testUserToken2), FriendsAndRequests.class);
        assertEquals(HttpStatus.OK, friendsAndRequestsResponse.getStatusCode());
        assertEquals(0, friendsAndRequestsResponse.getBody().getFriends().size());
    }
